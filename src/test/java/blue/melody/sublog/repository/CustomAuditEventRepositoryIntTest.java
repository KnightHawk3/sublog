package blue.melody.sublog.repository;

import blue.melody.sublog.SubLogApp;
import blue.melody.sublog.config.Constants;
import blue.melody.sublog.config.audit.AuditEventConverter;
import blue.melody.sublog.domain.PersistentAuditEvent;
...
import static blue.melody.sublog.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
